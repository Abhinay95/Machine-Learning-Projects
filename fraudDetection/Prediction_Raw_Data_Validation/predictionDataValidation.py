...
class Prediction_Data_validation:
    ...
    def deleteExistingGoodDataPredictingFolder(self):
        try:
    ...
    def deleteExistingBadDataPredictingFolder(self):
        try:
            path = 'Prediction_Raw_Files_Validated/'
    ...
    def validationFileNameRaw(self, regex, LengthOfDateStampInFile, LengthOfTimeStampInFile):
        ...
        self.deleteExistingBadDataPredictingFolder()
        self.deleteExistingGoodDataPredictingFolder()
