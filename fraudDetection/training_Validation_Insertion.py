...
class train_validation:
    ...
    def train_validation(self):
        try:
            ...
            #validating any column has all values missing
            self.raw_data.validateMissingValuesInWholeColumn()
            self.log_writer.log(self.file_object,"Raw Data Training validation completed !!")

            self.log_writer.log(self.file_object, "Data Transformation Started")
            ...
            self.log_writer.log(self.file_object, "Table creation successfully!!")
            self.log_writer.log(self.file_object, "Insertion of data into table started!!")

            # insert csv files in the table
            self.dBOperation.insertIntoTableGoodData('Training')
            self.log_writer.log(self.file_object, "Insertion in table successfully!!")
            ...
            self.log_writer.log(self.file_object, "Extarcted csv file from table!!")
