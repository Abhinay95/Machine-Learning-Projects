...
class Raw_Data_Validation:
    ...
    def moveBadFilesToArchiveBad(self):
        ...
        try:
            ...
            if os.path.isdir(source):
                ...
                if not os.path.isdir(path):
                    os.makedirs(path)
                dest = 'TrainingArchiveBadData/BadData_' + str(date)+"_"+str(current_time)
    ...
    def validateColumnLength(self, NumberOfColumns):
        try:
            ...
            self.logger.log(f, "Validation of Column length is completed!!")
        except OSError:
            f = open("Training_Logs/columnValidationLog.txt", 'a+')
    ...
    def validateMissingValuesInWholeColumns(self):
        try:
            ...
            self.logger.log(f, "Validation of missing values started!!")
